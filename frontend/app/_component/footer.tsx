    ...
    <footer className="w-full flex justify-center items-center border-t">
     <div className="w-full max-w-6xl p-4 gap-8 flex flex-col lg:flex-row lg:items-start">
       <div className="lg:flex-1 lg:basis-0 w-full lg:w-auto">
         ...
         <p className="text-muted-foreground lg:w-2/3">This headline is short, catchy, and informative. It accurately reflects the content of the website, which is a guide to the best of Bali. It also uses the word 'thousand' to evoke the image of Bali's many temples, which are one of the island's most popular tourist attractions.</p>
       </div>
       <div className="flex justify-center items-center lg:gap-8 gap-4 w-full lg:w-auto">
         <div className="flex flex-col justify-start items-start gap-4">
           <h1 className="text-primary font-bold flex justify-start items-center gap-1"><Layers2 className={cn('inline-block', iconClass)}/> Menu</h1>
